...
<div class="container mx-auto p-6">
    ...
    <div class="mb-4 flex items-center gap-3">
        ...
        <a href="<?php echo e(route('admin.users.download.csv')); ?>" class="inline-block px-4 py-2 bg-blue-600 text-white rounded">Download CSV</a>
        <a href="<?php echo e(route('admin.users.download.pdf')); ?>" class="inline-block px-4 py-2 bg-gray-700 text-white rounded">Download PDF</a>
    </div>
